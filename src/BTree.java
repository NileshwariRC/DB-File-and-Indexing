...
public class BTree {
	...
	public BTree(RandomAccessFile file, String tableName) {
		...
		try {
			...
			System.out.println("Unexpected Error BTree");
		}
	}
	...
	public void createNewInterior(int pageNumber, int rowID, int pageRight) {
		try {
			...
			System.out.println("Unexpected Error createNewInterior");
		}
	}
	...
	public void createEmptyTable() {
		...
		try {
			...
			System.out.println("Unexpected Error createEmptyTable");
		}
	...
	public void createNewTableLeaf(Map<String, ArrayList<String>> token) {
		try {
			...
			System.out.println("Unexpected Error createNewTableLeaf");
		}
	}
	...
	public int getNextMaxRowID() {
		...
		try {
			...
			System.out.println("Unexpected Error getNextMaxRowID");
		}
		return -1;
	...
	public boolean isPrimaryKeyExists(int newKey) {
		...
		if (cellOffset > 0) {
			try {
				...
				System.out.println("Unexpected Error isPrimaryKeyExists");
			}
	...
	public LinkedHashMap<String, ArrayList<String>> searchWithPrimaryKey(
		...
		if (cellOffset > 0) {
			try {
				...
				System.out.println("Unexpected Error searchWithPrimaryKey");
			}
	...
	public boolean deleteRecord(LinkedHashMap<String, ArrayList<String>> token) {
		...
		if (cellOffset > 0) {
			try {
				...
				System.out.println("Unexpected Error deleteRecord");
			}
	...
	private void searchLeftMostLeafNode() {
		...
		if (isLeafPage) {
			...
			try {
				...
				System.out.println("Unexpected Error searchLeftMostLeafNode");
			}
		}
	...
	private void searchRightMostLeafNode() {
		...
		if (isLeafPage) {
			...
			try {
				...
				System.out.println("Unexpected Error searchRightMostLeafNode");
			}
		}
	...
	public List<LinkedHashMap<String, ArrayList<String>>> searchNonPrimaryCol(
		...
		while (currentPage > 0) {
			try {
				...
				System.out.println("Unexpected Error searchNonPrimaryCol");
			}
		}
	...
	public List<LinkedHashMap<String, ArrayList<String>>> printAll() {
		...
		while (currentPage > 0) {
			try {
				...
				System.out.println("Unexpected Error printAll");
			}
		}
		return result;
	...
	private LinkedHashMap<String, ArrayList<String>> populateDataWithSearch(
		...
		try {
			...
			System.out.println("Unexpected Error populateDataWithSearch");
		}
	...
	private LinkedHashMap<String, ArrayList<String>> populateData(
		...
		try {
			...
			System.out.println("Unexpected Error populateData");
		}
	...
	private long[] getCellOffset(int rowId) {
		...
		try {
			...
			System.out.println("Unexpected Error getCellOffset");
		}
	...
	private void insertNewRecordInPage(Map<String, ArrayList<String>> token,
		...
		try {
			...
			System.out.println("Unexpected Error insertNewRecordInPage");
		}
		if (cellStartOffset < pageHeader_offset + 2) {
			...
			try {
				...
				System.out.println("Unexpected Error cellStartOffset < pageHeader_offset");
			}
		} else {
	...
	private boolean searchLeafPage(int rowId, boolean isFound) {
		...
		if (isLeafPage) {
			...
			try {
				...
				System.out.println("Unexpected Error searchLeafPage");
			}
			return isFound;
		}
	...
	private byte[] readCell(int loc) {
		...
		try {
			...
			System.out.println("Unexpected Error readCell");
		}
	...
	private int[] splitLeafPage(LinkedList<byte[]> page1Cells,
		...
		try {
			...
			System.out.println("Unexpected Error splitLeafPage");
	...
	private void writeCell(int pageLocation,
		...
		try {
			...
			System.out.println("Unexpected Error writeCell");
		}
	...
	private void writeCellInBytes(int pageLocation, byte[] b,
		...
		try {
			...
			System.out.println("Unexpected Error writeCellInBytes");
		}
	...
	private void writeToHeaderArray(long cellStartOffset, int rowID) {
		...
		try {
			...
			System.out.println("Unexpected Error writeToHeaderArray");
		}
	}
	...
	private void writeCellContent(int pageLocation2,
		...
		try {
			...
			System.out.println("Unexpected Error writeCellContent");
		}
			...
			case DATETIME:
				if (data_type.get(1) != null
					...
					try {
						...
						System.out.println("Unexpected Error DATETIME");
					}
				} else {
					binaryFile.writeLong(-1);
			...
			case DATE2:
				if (data_type.get(1) != null
					...
					try {
						...
						System.out.println("Unexpected Error DATE2");
					}
				} else {
					binaryFile.writeLong(-1);
	...
	public boolean close() {
		try {
			...
			System.out.println("Unexpected Error close");
			return false;
		}
	}
	...
	private void createPage(LinkedList<byte[]> pageCells) {
		try {
			...
			System.out.println("Unexpected Error createPage");
		}
	}
